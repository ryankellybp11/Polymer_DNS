      ...
      if (print3d .ne. 0) then 
        ...
        if((mod(it,iprnfrq) .eq. 0 .and. it .ne. 0) .or. it .eq. 1) then
            ...
            if (print3d .eq. 1 .or. print3d .eq. 2) then
                if (ipolyflag .eq. 1) then
                  call write_flowfield_ascii(it, up3d, vp3d, wp3d, wx3d, wy3d, wz3d, swirl_3d, real(imatrix), beta3d, xl, zl, print3d) ! Polymer
                else
                  call write_flowfield_ascii(it, up3d, vp3d, wp3d, wx3d, wy3d, wz3d, swirl_3d, real(imatrix), scp3d, xl, zl, print3d) ! Scalar only
                end if
            else 
                if (ipolyflag .eq. 1) then
                  call write_flowfield_plt(it, up3d, vp3d, wp3d, wx3d, wy3d, wz3d, swirl_3d, real(imatrix), beta3d, xl, zl) ! Polymer
                else
                  call write_flowfield_plt(it, up3d, vp3d, wp3d, wx3d, wy3d, wz3d, swirl_3d, real(imatrix), scp3d, xl, zl) ! Scalar only
                end if
            end if
        end if
    end if
